...
Public Class frmPayment
    ...
    Private Sub PaymentCash()
        If cashState = 0 Then
            If cardState = 1 And Trim(txtCardAmount.Text) = 0 Then
                ...
                btnCard.ForeColor = Color.SteelBlue
                cardState = 0
            End If
            ...
            If voucherState = 1 And Trim(txtVoucherAmount.Text) = 0 Then
                ...
                btnVoucher.ForeColor = Color.SteelBlue
                voucherState = 0
            End If


            txtCashAmount.Enabled = True
            btnCash.BackColor = Color.IndianRed
        ...
        Else
            ...
            btnCash.ForeColor = Color.SteelBlue
            cashState = 0
            txtCashAmount.Text = String.Format("{0:#,##0}", 0)

            If cardState = 1 Then 'recalculate card amount

                Dim data As New DataTable
                txtCardAmount.Text = String.Format("{0:#,##0}", 0)
                txtCharge.Text = String.Format("{0:#,##0}", 0)
    ...
    Private Function IsChargeCC(ByVal cardtype As String, ByVal edcid As String) As DataTable
        Try
            ...
            With cm
                .Connection = cn
                .CommandText = "SELECT minpayment Charge_MinPayment,bankcharge Charge_Rate" &
                                " FROM " & DB & ".dbo.mcard_charge" &
    ...
    Private Sub PaymentVoucher()
        If voucherState = 0 Then
            ...
            btnVoucher.BackColor = Color.IndianRed
            btnVoucher.ForeColor = Color.White
            voucherState = 1
