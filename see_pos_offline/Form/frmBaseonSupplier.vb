...
Imports sqlLib.Sql
Imports SEE_POS_OFFLINE.StackedHeader
        ...
        Try
            ...
            If table.Rows.Count > 0 Then
                ...
                With GridBaseOnSupplier
                    ...
                    .Columns(2).DataPropertyName = "consi_amt"
                    .Columns(3).DataPropertyName = "consi_qty"
                    .Columns(4).DataPropertyName = "credit_amt"
                    .Columns(5).DataPropertyName = "credit_qty"
