...
Public Class frmOpenCashier
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        Try
            ...
            With cm
                .Connection = cn
                .CommandText = "INSERT INTO " & DB & ".dbo.cashierbalance " &
                             " (cashierbal_userid,cashierbal_opendate,cashierbal_amount," &
                             " cashierbal_totalcash,cashierbal_totalcard,cashierbal_totalcharge,cashierbal_totalvoucher," &
                             " cashierbal_shift,cashierbal_closedate,cashierbal_note,cashierbal_employeeid) " &
                             " VALUES ('" & txtUserId.Text & "'," &
                             "'" & Format(dtDate.Value, "yyyy-MM-dd " & GetTimeNow()) & "'," &
                             "'" & CDec(txtAmount.Text) & "',0,0,0,0,'" & numShift.Value & "'" &
    ...
    Private Sub Company()
        ...
        Try
            ...
            query = "select coy_description,coy_Address01,coy_Address02,coy_NPWP from " & DB & ".dbo.mbranch" &
