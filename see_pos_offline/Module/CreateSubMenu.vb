...
Module CreateSubMenu
    ...
    Private Sub DropMenuSalesReport(ByVal mnu As ToolStripMenuItem)
        ...
        Dim mnuListingSalesAll As ToolStripMenuItem
        ...
        mnuListingSalesAll = New ToolStripMenuItem
        With mnuListingSalesAll
            .Text = "Listing Sales"
            .Name = "mnuListingSalesAll"
        End With

        mnuListingSales = New ToolStripMenuItem
        With mnuListingSales
            .Text = "Listing Sales by Payment"
        ...
        AddHandler mnuListingSalesAll.Click, AddressOf MenuItemClicked
        mnu.DropDownItems.Add(mnuListingSalesAll)
        ...
        Try
            Select Case mnuItem
                Case "mnuPOS"
                    ...
                    If logOn = "00-IT" Then
                        fPOS.EmployeeID = "Admin"
                    Else
                        fPOS.EmployeeID = Trim(table.Rows(0).Item(1))

                    End If

                    fPOS.Default_Customer = Trim(GetValueParamText("POS CUSTOMER"))
                    fPOS.Default_SlsOrg = Trim(GetValueParamText("POS SLSORG"))
                    fPOS.Default_SalesOffice = Trim(GetValueParamText("POS SALESOFFICE"))
                    fPOS.Default_CostCenter = Trim(GetValueParamText("POS COSTCENTER"))
                    fPOS.Default_Salesman = Trim(GetValueParamText("POS SALESMAN"))
                    fPOS.Default_Warehouse = Trim(GetValueParamText("DEFAULT WH"))

                    fPOS.MdiParent = MDIMain
                    'frmPOS.WindowState = FormWindowState.Normal
                    fPOS.Show()

                    AddHandler fPOS.FormClosed, AddressOf ActiveMdiChild_FormClosed
                ...
                Case "mnuBestSeller"
                    ...
                    AddHandler frm.FormClosed, AddressOf ActiveMdiChild_FormClosed
                    MDIMain.Text = "TMBookstore - Report"
                Case "mnuListingSalesAll"
                    frm = frmListingSalesAll
                    frm.MdiParent = MDIMain
