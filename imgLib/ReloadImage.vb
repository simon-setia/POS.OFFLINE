...
#Region "Private Variable"
    ...
    Private imgPasteClipboard As Bitmap
    ...
    Private imgRemove2 As Bitmap
    Private imgInsert2 As Bitmap
    Private imgPrint2 As Bitmap
...
#Region "Constructor"
    ...
    Public Sub New()
        ...
        imgPasteClipboard = New Bitmap(My.Resources.clipboard)
        imgEdit2 = New Bitmap(My.Resources.edit2)
        imgSearch2 = New Bitmap(My.Resources.search2)
        imgRemove2 = New Bitmap(My.Resources.remove2)
        ...
        imgUserGroup = New Bitmap(My.Resources.User)
...
#Region "Property"
    ...
    Public ReadOnly Property ImgBtnPasteClipboard() As Bitmap
        Get
            Return imgPasteClipboard
        End Get
    ...
    Public ReadOnly Property ImgBtnRemove2S() As Bitmap
        Get
            Return imgRemove2
        End Get
